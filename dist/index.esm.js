...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, {
        ...
        children,
        expanded ? React.createElement(Icon$19, {
...
var ExpandableLabel = function (_a) {
    ...
    return (React.createElement(Button, {
        ...
        "aria-label": "Hide or show expandable content",
        onClick: onClick,
        endIcon: expanded ? React.createElement(Icon$19, {
            color: "primary"
        }) : React.createElement(Icon$1c, {
            color: "primary"
        })
...
var BalanceInput = function (_a) {
    var value = _a.value,
        ...
        _c = _a.isWarning,
        isWarning = _c === void 0 ? false : _c,
        props = __rest(_a, ["value", "placeholder", "onChange", "currencyValue", "inputProps", "isWarning"]);
    return (React.createElement(StyledBalanceInput, __assign({
            isWarning: isWarning
        }, props),
        React.createElement(StyledInput$1, __assign({
            type: "text",
            value: value,
            onChange: onChange,
            placeholder: placeholder
        }, inputProps)),
        currencyValue && (React.createElement(Text, {
            fontSize: "12px",
            textAlign: "right",
            color: "textSubtle"
        }, currencyValue))));
...
var DefaultSeparator = React.createElement(Icon$1a, {
    color: "currentColor",
    width: "24px"
});
...
var ButtonMenu$1 = function (_a) {
    var _b = _a.activeIndex,
        ...
        _c = _a.scale,
        scale = _c === void 0 ? scales$6.MD : _c,
        _d = _a.variant,
...
var BackgroundImage = function (_a) {
    ...
    return React.createElement(Wrapper$3, __assign({
        ref: imgRef
    }, otherProps));
};
...
var Link = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    return React.createElement(StyledLink$1, __assign({
        as: "a",
        bold: true
    }, internalProps, props));
};
...
var getScale$2 = function (property) {
    return function (_a) {
        var _b = _a.scale,
            scale = _b === void 0 ? scales$3.MD : _b;
...
var PancakeToggle = function (_a) {
    ...
    return (React.createElement(PancakeStack, {
            scale: scale
        },
        React.createElement(PancakeInput, __assign({
            id: props.id || "pancake-toggle",
            scale: scale,
            type: "checkbox",
            checked: checked
        }, props)),
        React.createElement(PancakeLabel, {
                scale: scale,
                checked: checked,
...
var Progress = function (_a) {
    var _b = _a.variant,
        ...
        _c = _a.primaryStep,
        primaryStep = _c === void 0 ? 0 : _c,
        _d = _a.secondaryStep,
        secondaryStep = _d === void 0 ? null : _d,
        _e = _a.showProgressBunny,
        showProgressBunny = _e === void 0 ? false : _e;
    return (React.createElement(StyledProgress, {
            variant: variant
        },
...
var Spinner = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        ...
        React.createElement(FloatingPanIcon, {
            width: size + "px"
        })));
};
...
var Step = function (_a) {
    ...
    return (React.createElement(Flex, {
        ...
        React.createElement(ChildrenLeftWrapper, {
        ...
        React.createElement(Wrapper$2, null,
            ...
            index < numberOfSteps - 1 && React.createElement(Connector, {
                status: status
            })),
        React.createElement(ChildrenRightWrapper, {
            isVisible: isIndexPair
        }, children)));
};
...
var Tab = function (_a) {
    var _b = _a.isActive,
        ...
        onClick = _a.onClick,
        children = _a.children;
    return (React.createElement(StyledTab, {
            onClick: onClick,
...
var Modal = function (_a) {
    ...
    return (React.createElement(ModalContainer, __assign({
            minWidth: minWidth
        }, props),
        React.createElement(ModalHeader, {
            ...
            React.createElement(ModalTitle, null,
                onBack && React.createElement(ModalBackButton, {
                    onBack: onBack
                }),
                React.createElement(Heading, null, title)),
            !hideCloseButton && React.createElement(ModalCloseButton, {
                onDismiss: onDismiss
            })),
...
var LogoWithText = React.memo(Logo$2, function (prev, next) {
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(LogoWithText, {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, {
            ...
            onClick: togglePush,
            mr: "24px"
        }, isPushed ? (React.createElement(Icon$m, {
            width: "24px",
            color: "textSubtle"
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, {
            as: "a",
            href: href,
            "aria-label": "Pancake home page"
        }, innerLogo)) : (React.createElement(StyledLink, {
            to: href,
            "aria-label": "Pancake home page"
        }, innerLogo))));
};
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, {
            ...
            icon,
            React.createElement(LinkLabelMemo, {
                isPushed: isPushed
            }, label),
...
var Accordion$1 = React.memo(Accordion, function (prev, next) {
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
                ...
                entry.items.map(function (item) {
                    return (React.createElement(MenuEntry, {
                        ...
                        React.createElement(MenuLink, {
                            ...
                            item.status && (React.createElement(LinkStatus, {
        ...
        return (React.createElement(MenuEntry, {
            ...
            React.createElement(MenuLink, {
                ...
                entry.status && (React.createElement(LinkStatus, {
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(CakePrice$1, {
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, {
        ...
        React.createElement(HelpLink, {
                href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain",
                external: true
            },
            React.createElement(Icon$13, {
                color: "primary",
                mr: "6px"
            }),
